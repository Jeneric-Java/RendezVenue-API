...
class ParserTest {
    ...
    class testEventParser {
        ...
        void testNullInternalFieldsInput() throws ParseException {
            ...
            Event expected1 = new Event(
                    ...
                    "example.com",
                    EventType.MISC,
                    new Time(null, 2024, 10, 1, null, null, null),
                    null,
                    null);
    ...
    class testPageParser {
        ...
        void testValidInput() throws ParseException {
            ...
            Event event1 = new Event(null, "Event 1", "Event 1 @ Test Arena", "M2 5PD", "example.com", EventType.MISC, new Time(null, 2024, 10, 1, 10, 0, null), null, null);
            Event event2 = new Event(null, "Event 2", "Event 2 @ Test Arena", "M2 5PD", "example.com", EventType.MISC, new Time(null, 2024, 10, 2, 12, 30, null), null, null);
        ...
        void testNoPageInfo() throws ParseException {
            ...
            Event event1 = new Event(null, "Event 3", "Event 3 @ Test Arena", "M2 5PD", "example.com", EventType.MISC, new Time(null, 2025, 2, 1, 10, 0, null), null, null);
            Event event2 = new Event(null, "Event 4", "Event 4 @ Test Arena", "M2 5PD", "example.com", EventType.MISC, new Time(null, 2025, 2, 2, 12, 30, null), null, null);
